...
SOPCINFO_FILE := $(ABS_BSP_ROOT_DIR)/../../ambilight_system.sopcinfo
...
# Design Name 
# setting SOPC_NAME is ambilight_system
SOPC_NAME := ambilight_system
...
# setting SOPC_SYSID_BASE_ADDRESS is 0x8000000
SOPC_SYSID_FLAG += --sidp=0x8000000
ELF_PATCH_FLAG  += --sidp 0x8000000

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1590062290
SOPC_SYSID_FLAG += --timestamp=1590062290
ELF_PATCH_FLAG  += --timestamp 1590062290
